        ...
        <el-scrollbar class="pageleftscrollbar" :native="false">
          <div class="filegroupsList">
            ...
            <div
              ...
              :class="{active : active && item && active == item}"
      ...
      <div class="ChooserightList">
        <div class="demoimagelist">
          <div class="demo-image">
            <div
              :class="{block:true,clickfalse:true,activeborder:ismultiple?currentchoosevideoList.includes(fit):currentchoosevideo._id == fit._id}"
              v-for="(fit,index) in filesimagevideo"
              @click="selectVideo(fit)"
            >
              <div
                class="xuanze-gou"
                v-show="ismultiple?currentchoosevideoList.includes(fit):currentchoosevideo._id == fit._id"
              >
